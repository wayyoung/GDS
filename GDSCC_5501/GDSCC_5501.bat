...
start javaw -Xverify:none -Xmx128M -Dsun.java2d.d3d=false -Djava.library.path=%GDS_HOME%\lib -Dlog4j.configurationFile=log4j2.xml -Dgdscc.configurationFile=GDSCC_5501.windows.properties -classpath %GDSCC_CP%  gds.GDSCC %1