...
java -Xmx128M -DSERIAL_PORT_LIST=/dev/ttyCOM01:/dev/ttyCOM02:/dev/ttyCOM03:/dev/ttyCOM04 -Dlog4j.configurationFile=log4j2.xml -Dgdscc.configurationFile=GDSCC_5501.linux.properties -classpath ${GDSCC_CP}  gds.GDSCC $1 &
